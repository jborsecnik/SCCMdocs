...
6.	Log in to the Intune portal.
  > [!Important]    
  > Do not use the Intune classic console. You must log in to Intune in the Azure portal.
7.  On the Microsoft Intune blade, click **Device enrollment**.
8.  On the Device enrollment Overview blade, see the MDM authority property. Confirm that the MDM authority has been changed to **Microsoft Intune**. 
